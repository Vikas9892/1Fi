  ...
  return (
    <AppShell>
      <main className="flex flex-col gap-6 pb-24 md:pb-12">
        {/* Hero Section */}
        <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#712CDC] via-[#8534f5] to-[#5017a8] text-white p-6 sm:p-10 lg:p-12 shadow-xl shadow-[#712CDC]/15">
          <div className="relative z-10 max-w-3xl lg:max-w-4xl flex flex-col gap-3.5">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-purple-100/90 leading-relaxed max-w-2xl">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
          ...
          <div className="rounded-2xl border border-zinc-200/90 bg-white p-5 lg:p-6 shadow-xs flex flex-col justify-between">
          ...
          <div className="rounded-2xl border border-purple-100 bg-[#fbf9ff] p-5 lg:p-6 shadow-xs flex flex-col justify-between">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-purple-900 uppercase tracking-wider">
                Available Purchase Limit
              </span>
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#ede8ff] text-[#712CDC]">
                <Wallet className="h-4 w-4" />
              </div>
            </div>
            <div className="mt-4">
              <span className="text-2xl sm:text-3xl font-extrabold text-[#712CDC]">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
          <div className="rounded-2xl border border-zinc-200/80 bg-white p-5 lg:p-6 shadow-2xs">
            <div className="h-10 w-10 rounded-xl bg-purple-50 text-[#712CDC] flex items-center justify-center mb-3">
              <ShieldCheck className="h-5 w-5" />
            </div>
            <h3 className="text-sm sm:text-base font-bold text-zinc-900">0% No-Cost EMI</h3>
          ...
          <div className="rounded-2xl border border-zinc-200/80 bg-white p-5 lg:p-6 shadow-2xs">
            ...
            <h3 className="text-sm sm:text-base font-bold text-zinc-900">Keep Your Returns</h3>
            <p className="text-xs sm:text-sm text-zinc-500 mt-1 leading-relaxed">
          ...
          <div className="rounded-2xl border border-zinc-200/80 bg-white p-5 lg:p-6 shadow-2xs">
            ...
            <h3 className="text-sm sm:text-base font-bold text-zinc-900">Regulated NBFC Partners</h3>
            <p className="text-xs sm:text-sm text-zinc-500 mt-1 leading-relaxed">
        ...
        {/* Call to action card */}
        <section className="rounded-2xl border border-zinc-200/90 bg-white p-6 lg:p-8 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xs">
          <div>
          ...
          <Link
            href="/shop"
            className="inline-flex items-center gap-2 rounded-xl bg-[#712CDC] px-5 py-3 text-xs sm:text-sm font-bold text-white shadow-md hover:bg-[#5e24b7] transition-all shrink-0"
          >

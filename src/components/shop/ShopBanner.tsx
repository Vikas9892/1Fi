...
export function ShopBanner() {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#712CDC] via-[#8534f5] to-[#5017a8] text-white p-4 sm:p-6 lg:p-7 shadow-md shadow-[#712CDC]/15">
